...
public class RegistrationService {
    ...
    public String confirmToken(String token) {
        ConfirmationToken confirmationToken = confirmationTokenService
                .getToken(token)
                .orElseThrow(() ->
                        new IllegalStateException("Kod nie został odnaleziony"));
        ...
        if (expiredAt.isBefore(LocalDateTime.now())) {
            throw new IllegalStateException("Kod wygasł");
        }

        confirmationTokenService.setConfirmedAt(token);

        /*UWIERZYTELNIENIE KONTA PO LINKU Z MAILA*/
        userService.enableUser(
                confirmationToken.getUser().getEmail());

        return "accountConfirmationView";
    }

    /*RANDOMOWY TEMPLATE*/
    private String buildEmail(String name, String confirmationLink) {
        ...
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hej! " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Dziękujemy za rejestrację. Kliknij poniższy link by aktywować konto: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + confirmationLink + "\">Aktywuj konto</a> </p></blockquote>\n Link wygaśnie za 60 min. <p>Do zobaczenia!</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
